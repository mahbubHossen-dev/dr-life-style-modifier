        ...
        <div>
            <div className="py-8 px-4 mx-auto max-w-screen-sm sm:py-16 lg:px-6 transition-all duration-300">
                ...
                <div className="shadow p-5 rounded">
                    ...
                    <form method="post" action="https://mdabdulkaiyum.in/user_login">
                        <input type="hidden" name="_token" value="iifVLxTiQqNlmkvEyu7gXN0emtXQ9B4mlCK1mIRz">            <span className="block mb-2  text-sm font-medium text-gray-900 dark:text-gray-300" />ফোন নম্বর বা ইমেইলঃ </span>
                            <div className="relative ">
                                <input type="text" id="usernmae_mail" className="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" name="email_or_phone" placeholder="" />
                                    <label for="usernmae_mail" className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/3     peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">ফোন নম্বর বা ইমেইল দিন </label>
                            </div>
                            ...
                            <div className="flex justify-between items-center mt-5">
                                <button type="submit" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded text-sm px-5 py-2.5 text-center mr-2 mb-2 transition-all duration-300">
                                    লগিন করুন
                                </button>
